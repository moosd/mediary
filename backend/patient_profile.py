...
def patient_profile():
    ...
    """
    return 'First Name: %s' % first_name
    return 'Last Name: %s' % last_name
    return 'DOB: %s' % birth_date
    return 'Gender: %s' % gender
    return 'NHS Number: %s' % nhs_number
    """
    ...
    (Xa1pS) - allergic to morphine sulfate<br/></td></tr><tr><td>14 Nov 2018</td><td>Lee Edwards ('Other' Community Health Service)  - Broad Walk Medical Practice</td><td>Diagnosis: Allergic reaction to drug (Xa1pS)to asprin<br/></td></tr></tbody></table></div>"""
